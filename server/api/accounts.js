          ...
          method: function(request, reply) {
            User.findByUsername(request.payload.username, (err, user) => {
              ...
              if (
                ...
                return reply(
                  Boom.conflict(
                    'User is already linked to another account. Unlink first.'
                  )
                );
              }
        ...
        },
        {
          ...
          method: function(request, reply) {
            if (
              ...
              return reply(
                Boom.conflict(
                  'Account is already linked to another user. Unlink first.'
                )
              );
            }
            ...
            const update = {
              $set: {
                'roles.account': {
                  ...
                  name:
                    request.pre.account.name.first +
                    ' ' +
                    request.pre.account.name.last,
                },
              },
            };
