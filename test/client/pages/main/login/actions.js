...
lab.experiment('Login Actions', () => {
  ...
  lab.test.skip(
    'it calls ApiActions.post from login (redirect to returnUrl)',
    done => {
  ...
  lab.test.skip(
    'it calls ApiActions.post from login (redirect to admin)',
    done => {
      const windowLocation = global.window.location;
  ...
  lab.test.skip(
    'it calls ApiActions.post from login (redirect to account)',
    done => {
      const windowLocation = global.window.location;
