...
lab.experiment('User Class Methods', () => {
  ...
  lab.test(
    'it returns nothing for find by credentials when password match fails',
    done => {
...
lab.experiment('User Instance Methods', () => {
  ...
  lab.test(
    'it exits early when hydrating roles where roles are missing',
    done => {
      const user = new User({ username: 'ren' });
  ...
  lab.test(
    'it exits early when hydrating roles where hydrated roles exist',
    done => {
      const user = new User({
        username: 'ren',
        roles: {
  ...
  lab.test(
    'it returns an error when hydrating roles and find by id fails',
    done => {
  ...
  lab.test(
    'it returns successful when hydrating roles where there are none defined',
    done => {
      const user = new User({
        username: 'ren',
        roles: {},
