...
lab.experiment('Admin Instance Methods', () => {
  ...
  lab.test(
    'it exits early when hydrating groups where groups are missing',
    done => {
      const admin = new Admin({
        name: {
          first: 'Ren',
  ...
  lab.test(
    'it exits early when hydrating groups where hydrated groups exist',
    done => {
      const admin = new Admin({
        name: {
          first: 'Ren',
  ...
  lab.test(
    'it returns an error when hydrating groups and find by id fails',
    done => {
  ...
  lab.test(
    'it returns an error when checking permission and hydrating groups fails',
    done => {
  ...
  lab.test(
    'it returns correct permission from hydrated group permissions',
    done => {
      const admin = new Admin({
        name: {
          first: 'Ren',
